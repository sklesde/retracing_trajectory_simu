...
class TrajectoryRetracing(Node):
    ...
    def __init__(self):
        ...
        # -------- Publishers --------
        self.cmd_vel_pub = self.create_publisher(TwistStamped, '/cmd_vel_teleop', 10) #/cortex/cmd_vel_teleop
        ...
        self.planned_path_publisher = self.create_publisher(Path_msgs, '/row_path', latched_qos)
