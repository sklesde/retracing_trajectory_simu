...
class TrajectoryRetracing(Node):
    def __init__(self):
        ...
        self.dist_to_validate_goal = 0.2 # in meters
        self.K = 0.3
        self.Kd = 1.2
        self.v_min = 0.01
        self.v_max = 0.3# in m/s
    ...
    def following_path(self, poses):
        ...
        L_sq = x_local**2 + y_local**2 #L_sq = r² = x²+y²
        ...
        if L_sq > 0.001: #sqrt(0.001) = 0.0316m, so the trajectory is considered as perfect if the robot stay at a maxximum of 3,16 cm from the trajectory
